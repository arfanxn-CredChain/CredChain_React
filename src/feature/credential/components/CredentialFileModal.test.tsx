...
describe("CredentialFileModal", () => {
  it("renders nothing when closed", () => {
    ...
    render(<CredentialFileModal file={file} open={false} onClose={() => {}} />, {
  ...
  it("renders image in dialog when open", () => {
    ...
    render(<CredentialFileModal file={file} open={true} onClose={() => {}} />, {
      wrapper: TestProviders,
    });
  ...
  it("calls onClose when close button is clicked", async () => {
    const onClose = vi.fn();
    const file = makeImageFile();
    render(<CredentialFileModal file={file} open={true} onClose={onClose} />, {
      wrapper: TestProviders,
    });
