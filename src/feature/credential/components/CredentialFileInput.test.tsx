...
describe("CredentialFileInput", () => {
  it("renders drop zone hint when no file selected", () => {
    render(
      <CredentialFileInput file={null} onChange={() => {}} />,
    );
  ...
  it("shows filename when file is selected", () => {
    ...
    render(
      <CredentialFileInput file={file} onChange={() => {}} />,
    );
  ...
  it("calls onChange with null when remove button clicked", async () => {
    ...
    const file = makeFile();
    render(
      <CredentialFileInput file={file} onChange={onChange} />,
    );
  ...
  it("calls onChange with file when file selected via hidden input", () => {
    const onChange = vi.fn();
    render(
      <CredentialFileInput file={null} onChange={onChange} />,
    );
  ...
  it("calls onExpand when expand button clicked", async () => {
    ...
    render(
      <CredentialFileInput file={file} onChange={() => {}} onExpand={onExpand} />,
    );
  ...
  it("shows error message below when error prop is set", () => {
    render(
      <CredentialFileInput file={null} onChange={() => {}} error="File required" />,
    );
