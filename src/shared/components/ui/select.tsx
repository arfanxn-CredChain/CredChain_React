...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex w-full items-center justify-between py-3 px-4 border border-gray-200 rounded-xl",
      "bg-gray-50 text-navy text-sm shadow-sm",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-surface text-navy border border-gray-100 shadow-xl shadow-gray-200/50",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-xs font-bold uppercase tracking-wider text-gray-400",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "py-2 pl-8 pr-2 text-sm rounded-md outline-none",
